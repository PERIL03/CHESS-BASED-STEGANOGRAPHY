...
# Configure CORS (allow specific origins if CORS_ORIGINS is provided, else allow all for hackathon/testing)
...
# App directories and limits from environment
UPLOAD_FOLDER = os.getenv('UPLOAD_FOLDER', 'uploads')
OUTPUT_FOLDER = os.getenv('OUTPUT_FOLDER', 'outputs')
STORAGE_FOLDER = os.getenv('STORAGE_FOLDER', 'blockchain_storage')
ALLOWED_EXTENSIONS = {'txt', 'png', 'jpeg', 'pgn'}
MAX_FILE_SIZE = int(os.getenv('MAX_FILE_SIZE', 16 * 1024 * 1024))  # 16 MB default

# Flask limits (enforce maximum upload size)
...
# X402 micropayment configuration (overrideable via env)
